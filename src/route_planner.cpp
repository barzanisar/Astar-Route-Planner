...
RouteModel::Node *RoutePlanner::NextNode() {
    // Sort the open_list in descending order according to the sum of the h value and g value.
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    while (node != start_node) {
        ...
        // For each node in the chain, add the distance from the node to its parent to the distance attribute.
